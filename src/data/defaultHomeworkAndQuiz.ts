...
export const DEFAULT_HOMEWORK: HomeworkItem[] = [
  {
    ...
    completedByStudents: [
      { studentId: 'std-1a-1', studentName: 'Adrianus Danga', completedAt: new Date().toISOString() },
      { studentId: 'std-1a-2', studentName: 'Agnes Teresia', completedAt: new Date().toISOString() },
      { studentId: 'std-1a-4', studentName: 'Clara Maria Sola', completedAt: new Date().toISOString() },
    ],
  },
  {
    id: 'hw-1a-indo-1',
    ...
    completedByStudents: [
      { studentId: 'std-1a-1', studentName: 'Adrianus Danga', completedAt: new Date().toISOString() },
      { studentId: 'std-1a-2', studentName: 'Agnes Teresia', completedAt: new Date().toISOString() },
      { studentId: 'std-1a-3', studentName: 'Bonaventura Mbay', completedAt: new Date().toISOString() },
      { studentId: 'std-1a-4', studentName: 'Clara Maria Sola', completedAt: new Date().toISOString() },
      { studentId: 'std-1a-5', studentName: 'Dionisius Raga', completedAt: new Date().toISOString() },
      { studentId: 'std-1a-6', studentName: 'Elisabeth Leko', completedAt: new Date().toISOString() },
    ],
  },
  {
    id: 'hw-2a-ipas-1',
