...
export default function App() {
  ...
  const getHomeroomTeacherName = (cls: ClassGroup) => {
    if (cls.startsWith('1')) return 'Ibu Maria S.Pd';
    if (cls.startsWith('2')) return 'Ibu Teresa S.Pd';
    if (cls.startsWith('3')) return 'Bapak Yos S.Pd';
    if (cls.startsWith('4')) return 'Ibu Fransiska S.Pd';
    if (cls.startsWith('5')) return 'Bapak Stefanus S.Pd';
    return 'Bapak Antonius S.Pd';
  };
