...
import { ClassGroup, HomeworkItem, Student, StudentAchievement, StudentProgressReport } from '../types';
import {
  Award,
  BookOpen,
  CheckCircle2,
    ...
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div className="bg-gradient-to-r from-emerald-600 via-teal-600 to-blue-700 text-white rounded-3xl p-6 shadow-xl border-4 border-amber-400 relative overflow-hidden space-y-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
          ...
          {/* Contact Homeroom Teacher Button */}
          <a
            href={waUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="bg-green-500 hover:bg-green-400 text-white font-black text-xs px-5 py-3 rounded-2xl border-2 border-green-300 shadow-lg flex items-center gap-2 uppercase tracking-wide transition-all scale-105 active:scale-95 shrink-0"
          >
