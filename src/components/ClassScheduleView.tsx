...
export const ClassScheduleView: React.FC<ClassScheduleViewProps> = ({
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-[32px] p-6 border-4 border-blue-100 dark:border-slate-800 shadow-xl flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          <h2 className="text-2xl font-black text-blue-950 dark:text-white flex items-center gap-3">
